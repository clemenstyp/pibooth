...
DEFAULT = odict((
    ...
    ("PICTURE",
        odict((
            ...
            ("exif_model",
                ('pibooth',
                 "EXIF Model of resulting Picture",
                 None, None)),
            ("exif_make",
                ('pibooth',
                 "EXIF Make of resulting Picture",
                 None, None)),
            ("exif_software",
                 ('pibooth',
                  "EXIF Software of resulting Picture",
                  None, None)),
            ("exif_description",
                 ('pibooth Image',
                  "EXIF Description of resulting Picture",
                  None, None)),
            ("exif_document_name",
                 ('pibooth',
                  "EXIF Model of resulting Picture",
            ...
            ("exif_artist",
                 ('pibooth',
                  "EXIF Artist of resulting Picture",
                  None, None)),
            ("exif_host_computer",
                 ('https://github.com/werdeil/pibooth',
                  "EXIF Host Computer of resulting Picture",
                  None, None)),
            ("exif_copyright",
                 ('',
                  "EXIF Copyright of resulting Picture",
                  None, None)),
            ("exif_camera_owner",
             ('',
              "EXIF Campera Owner of resulting Picture",
              None, None)),
        ))
     ),
    ("CAMERA",
        ...
        odict((
            ...
            ("black_white",
                 (False,
                  ...
                  "Print black and white", ['True', 'False'])),
            ("printer_delay",
                (10,
    ...
    ("CONTROLS",
        odict((
            ...
            ("menu_btn_pin",
                 (18,
                  "Physical GPIO IN pin to show menu",
                  None, None)),
            ("startup_led_pin",
                (29,
        ...
        odict((
            ("upload_image",
             (False,
              ...
              "Upload Image", ['True', 'False'])),
            ("show_qr_on_screen",
             (False,
              "Show QR Code on idle screen",
              "Show QR Code", ['True', 'False'])),
            ("print_qr_code",
             ("Picture",
              "Print 'Picture' or 'QR Code' or 'Picture and Qr Code'",
              "Print picture or QR Code", ['Picture', 'Qr Code', 'Picture and Qr Code'])),
            ("server_url",
             ("https://example.org/foto/upload.php",
              "Upload Server URL",
              "URL: ", "https://example.org/foto/upload.php")),
            ("server_pwd",
             ("TOP-SECTRET",
              "Upload Server Password",
              "PASS: ", "TOP-SECTRET")),
            ("qr_code_link",
             ("https://example.org/foto/uploads/{hash}",
              "Server Link Template - {hash} will be replaces with the picture hash",
              "Link: ", "https://example.org/foto/uploads/{hash}")),
        ))
     ),
))
